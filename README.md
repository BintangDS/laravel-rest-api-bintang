...
You can verify the application's functionality using both automated and manual tests.
...
### 2. Manual Testing Guide (Postman)
...
To manually test the API endpoints and verify role-based security rules:
...
#### B. Standard E-Commerce Workflow (Happy Path)
1. **Login as Admin**:
...
#### C. Security & Authorization Checks (Role Protection)
Verify that middleware permissions prevent unauthorized access:

##### Scenario I: Unauthenticated Access (401 Unauthorized)
...
##### Scenario II: Regular User Restriction (403 Forbidden)
...
#### D. Logout & Token Revocation Flow
